...
(function(P, X, u) {
    ...
    function Ea(b, a, c, d) {
        ...
        if (a) {
            ...
            if (E(b))
                for (var f = a.length = 0; f < b.length; f++) e = Ea(b[f], null, c, d), J(b[f]) && (c.push(b[f]), d.push(e)), a.push(e);
            else {
                var g = a.$$hashKey;
    ...
    function ea(b, a) {
        ...
        if (c == typeof a && "object" == c)
            if (E(b)) {
                ...
                for (d in a)
                    if (!c.hasOwnProperty(d) && "$" !== d.charAt(0) && a[d] !== u && !G(a[d])) return !1;
                return !0
            }
        return !1
    }
    ...
    function Id(b, a) {
        ...
        b = C(b);
        for (d = 0; d < e; ++d)
            if (c = sb[d] + a, x(c = b.attr(c))) return c;
        return null
    }
    ...
    function nf(b, a, c, d) {
        ...
        m.cookies = function(a, b) {
            var d, e, f, g;
            if (a) b === u ? p.cookie = encodeURIComponent(a) + "=;path=" + ha + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" : x(b) && (d = (p.cookie = encodeURIComponent(a) + "=" + encodeURIComponent(b) + ";path=" + ha).length + 1, 4096 < d && c.warn("Cookie '" + a + "' possibly not set or overflowed because it was too large (" + d + " > 4096 bytes)!"));
            else {
                if (p.cookie !== y)
                    for (y = p.cookie, d = y.split("; "), wa = {}, f = 0; f < d.length; f++) e = d[f], g = e.indexOf("="), 0 < g && (a = k(e.substring(0, g)),
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function(a, b, c, r, S, K, n, D, H, v, A) {
            ...
            function ba(a, b, c, d, e, f) {
                function g(a, c, d, e) {
                    ...
                    if (n)
                        for (D =
                            Array(c.length), q = 0; q < h.length; q += 3) f = h[q], D[f] = c[f];
                    else D = c;
                    q = 0;
            ...
            function W(a, b, c, d, g) {
                ...
                switch (a.nodeType) {
                    case na:
                        ...
                        J(a) && (a = a.animVal);
                        if (x(a) && "" !== a)
                            for (; l = f.exec(a);) k = ya(l[2]), ha(b, k, "C", d, g) && (c[k] = T(l[3])),
            ...
            function y(a,
                ...
                for (var v = -Number.MAX_VALUE, N, H = n.controllerDirectives, ba, I = n.newIsolateScopeDirective, ja = n.templateDirective, wa = n.nonTlbTranscludeDirective, ha = !1, fb = !1, B = n.hasElementTranscludeDirective, w = e.$$element = C(d), L, ca, U, R = f,
                    ...
                    if (U = L.transclude) ha = !0, L.$$tlb || (Oa("transclusion", wa, L, w), wa = L), "element" == U ? (B = !0, v = L.priority, U = w, w = e.$$element = C(X.createComment(" " + ca + ": " + e[ca] + " ")), d = w[0], V(g, Za.call(U,
                        0), d), R = F(U, f, v, l && l.name, {
                        nonTlbTranscludeDirective: wa
                    })) : (U = C(Vb(d)).contents(), w.empty(), R = F(U, f));
                    if (L.template)
                        if (fb = !0, Oa("template", ja, L, w), ja = L, U = G(L.template) ? L.template(w, e) : L.template, U = Tc(U), L.replace) {
                            l = L;
            ...
            function z(a) {
                for (var b = 0, c = a.length; b < c; b++) a[b] = Pb(a[b], {
                    $$isolateScope: !0
                })
            }
                ...
                $set: function(a, b, d, e) {
                    ...
                    if ("a" === g && "href" === a || "img" === g && "src" === a) this[a] = b = A(b, "src" === a);
                        ...
                        for (var g = "", h = T(b), l = /(\s+\d+x\s*,|\s+\d+w\s*,|\s+,|,\s+)/, l = /\s/.test(h) ?
                                l : /(,)/, h = h.split(l), l = Math.floor(h.length / 2), k = 0; k < l; k++) var q = 2 * k,
                            g = g + A(T(h[q]), !0),
                            g = g + (" " + T(h[q + 1]));
                        h = T(h[2 * k]).split(/\s/);
                        g += A(T(h[0]), !0);
    ...
    function Ie() {
        ...
        this.$get = ["$parse", "$exceptionHandler", "$sce", function(c, d, e) {
            ...
            function g(f, g, t, r) {
                ...
                r = !!r;
                for (var n, D, H = 0, v = [], A = [], N = f.length, F = [], s = []; H < N;)
                    if (-1 != (n = f.indexOf(b, H)) && -1 != (D = f.indexOf(a, n + h))) H !== n && F.push(S(f.substring(H, n))), H = f.substring(n + h, D), v.push(H), A.push(c(H, K)), H = D + l, s.push(F.length), F.push("");
                    else {
                ...
                $watchCollection: function(a,
                    ...
                    function c(a) {
                        ...
                        if (!z(e)) {
                            if (J(e))
                                if (Ta(e))
                                    for (f !== q && (f = q, t = f.length = 0, k++), a = e.length, t !== a && (k++, f.length = t = a), b = 0; b < a; b++) h = f[b], g = e[b], d = h !== h && g !== g, d || h === g || (k++, f[b] = g);
                                else {
                                    f !== m && (f = m = {}, t = 0, k++);
                                    a = 0;
    ...
    function nd(b, a, c, d, e) {
        ...
        if (k) 0 < e && 1 > b && (h = b.toFixed(e), b = parseFloat(h));
            ...
            var g = ("" + b).split(od),
                ...
                t = a.gSize;
            if (k.length >= q + t)
                for (p = k.length - q, m = 0; m < p; m++) 0 === (p - m) % t && 0 !== m && (h += c), h += k.charAt(m);
    ...
    s({
        ...
        attr: function(b, a, c) {
            ...
            if (Fb[d])
                ...
                else return b[a] || (b.attributes.getNamedItem(a) || B).specified ? d : u;
        ...
        Uf = {
            ...
            search: function(a, c) {
                switch (arguments.length) {
                    ...
                    case 1:
                        if (x(a) || V(a)) a =
                            a.toString(), this.$$search = rc(a);
                        else if (J(a)) a = Ea(a, {}), s(a, function(c, e) {
                            null == c && delete a[e]
                        }), this.$$search = a;
        ...
        readString: function(a) {
            ...
            for (var d = "", e = a, f = !1; this.index < this.text.length;) {
                ...
                if (f) "u" === g ? (f = this.text.substring(this.index + 1, this.index + 5), f.match(/[\da-f]{4}/i) || this.throwError("Invalid unicode escape [\\u" + f + "]"), this.index +=
                    4, d += String.fromCharCode(parseInt(f, 16))) : d += Yf[g] || g, f = !1;
                else if ("\\" === g) f = !0;
                else {
                    if (g === a) {
                        this.index++;
        ...
        functionCall: function(a, c) {
            ...
            return function(g, h) {
                var l = c ? c(g, h) : y(c) ? u : g,
                    k = a(g, h, l) || B;
                if (f)
                    for (var m = d.length; m--;) f[m] = la(d[m](g, h), e);
                la(l, e);
                if (k) {
    ...
    var ie = ["$animate", function(a) {
        ...
        ne = ["$parse", "$animate", function(a, c) {
            ...
            return {
                ...
                compile: function(f, g) {
                    var h = g.ngRepeat,
                        l = X.createComment(" end ngRepeat: " +
                            h + " "),
                    ...
                    return function(a, f, g, k, m) {
                        ...
                        a.$watchCollection(p, function(g) {
                            ...
                            K = Array(B);
                            for (k = 0; k < B; k++)
                                if (z = g === J ? k : J[k], G = g[z], E = p(z, G, k), t[E]) x = t[E], delete t[E], v[E] = x, K[k] = x;
                                else {
                            ...
                            for (F in t) {
                                ...
                                c.leave(E);
                                if (E[0].parentNode)
                                    for (k = 0, p = E.length; k < p; k++) E[k].$$NG_REMOVED = !0;
                                x.scope.$destroy()
                            }
                            for (k = 0; k < B; k++)
                                if (z = g === J ? k : J[k], G = g[z], x = K[k], x.scope) {
                                    F = y;
                    ...
                    function p(e, f, g) {
                        ...
                        function p() {
                            ...
                            for (B = c.length; x < B; x++) {
                                ...
                                M = null;
                                A = 0;
                                for (E = l.length; A < E; A++) d = l[A], (v = u[A + 1]) ? (M = v.element, v.label !== d.label && (m(O, v.label, !1), m(O, d.label, !0), M.text(v.label = d.label), M.prop("label", v.label)), v.id !== d.id && M.val(v.id = d.id), M[0].selected !== d.selected && (M.prop("selected", v.selected = d.selected), Ra && M.prop("selected", v.selected))) : ("" === d.id && w ? T = w : (T = D.clone()).val(d.id).prop("selected", d.selected).attr("selected", d.selected).prop("label", d.label).text(d.label), u.push(v = {
                                    element: T,
                                    label: d.label,
                                    id: d.id,
                                    selected: d.selected
